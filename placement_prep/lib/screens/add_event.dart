...
import 'package:placement_prep/screens/event_firestore_service.dart';
            ...
            children: <Widget>[
              Padding(
                ...
                child: TextFormField(
                  controller: _title,
                  validator: (value) =>
                  (value.isEmpty) ? "Please Enter Comapany name" : null,
                  style: style,
              ...
              Padding(
                ...
                child: TextFormField(
                  controller: _link,
                  validator: (value) =>
                  (value.isEmpty) ? "Please Enter Link" : null,
                  style: style,
                  decoration: InputDecoration(
                      labelText: "Link",
                      filled: true,
                    ...
                    onPressed: () async {
                      if (_formKey.currentState.validate()) {
                        ...
                        if (widget.note != null) {
                          ...
                          /*await eventDBS.updateData(widget.note.id, data);EventModel(
                            id: widget.note.id,
                            title: _title.text,
                            description: _description.text,
