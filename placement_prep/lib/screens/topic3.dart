...
class Topic3 extends StatefulWidget {
  Topic3({Key key, this.title}) : super(key: key);
...
class _Topic3State extends State<Topic3> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      appBar: AppBar(
        title: Text("To Do list - Internet Of Things"),
                  ...
                  child: Row(
                    ...
                    //crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        ...
                        Text("Fundamentals of IOT",style: TextStyle(fontSize: 17.0)),
                ...
                Padding(
                  ...
                  child: Row(
                      children: <Widget>[
                        ...
                        Text("Design methodology",style: TextStyle(fontSize: 17.0)),
                      ]
                  ),
                ),
                Padding(
                  ...
                  child: Row(
                      children: <Widget>[
                        ...
                        Text("Sensors and activators",style: TextStyle(fontSize: 17.0)),
                      ]
                  ),
                ),
                Padding(
                  ...
                  child: Row(
                    //mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: <Widget>[
                        ...
                        Text("Zigbee-RFID-Wi-Fi",style: TextStyle(fontSize: 17.0)),
                      ]
                  ),
                ),
                Padding(
                  ...
                  child: Row(
                    //mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: <Widget>[
                        ...
                        Text("Arduino/Intel Galileo/Raspberry Pi",style: TextStyle(fontSize: 17.0)),
                      ]
                  ),
                ),
                Padding(
                  ...
                  child: Row(
                    //mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: <Widget>[
                        ...
                        Text("Web servics",style: TextStyle(fontSize: 17.0)),
                      ]
                  ),
                ),
                Padding(
                  ...
                  child: Row(
                    //mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: <Widget>[
                        ...
                        Text("Realtime applications of IOT",style: TextStyle(fontSize: 17.0)),
                      ]
                  ),
                ),
                Padding(
                  ...
                  child: Row(
                    //mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: <Widget>[
                        ...
                        Text("Connecting IOT to cloud",style: TextStyle(fontSize: 17.0)),
                      ]
                  ),
                ),
                Padding(
                  ...
                  child: Row(
                    //mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: <Widget>[
                        ...
                        Text("Database for IOT",style: TextStyle(fontSize: 17.0)),
                      ]
                  ),
                ),
